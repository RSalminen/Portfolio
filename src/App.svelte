...
<main class="min-h-screen min-w-screen flex overflow-x-hidden">
  ...
  <!-- Sidebar -->
  <div class="bg-cyan-950 min-h-full w-[230px] fixed overscroll-y-none shadow-black text-blue-50">
  ...
  <div class="w-[230px] invisible"></div>
    ...
    >
      ...
      <div slot="foreground">
        <section use:scrollRef={'about'} class="min-h-screen flex justify-center">
          <div class="w-[70%] flex flex-col gap-5 pt-6">
        ...
        <section use:scrollRef={'projects'} class="w-full min-h-screen flex flex-col items-center pt-3">
          <div class="w-[70%] flex flex-col gap-5 pt-4">
