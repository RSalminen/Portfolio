...
<main class="min-h-screen min-w-screen flex">
  ...
  <div class="w-[200px] invisible"></div>
          ...
          <div class="w-[70%] flex flex-col gap-5 pt-5">
            ...
            <div class="flex flex-col gap-2">
              <Text>
                ...
                My studies were heavily focused on energy conversion, fluid dynamics and programming.
                I currently work at ARKANCE as a software designer, and my tasks span from maintaining local IP software applications
                to developing new software in customer projects.
        ...
        <section use:scrollRef={'projects'} class="w-full min-h-screen flex flex-col items-center pt-3">
          <div class="w-[70%] flex flex-col gap-5 pt-5">
            ...
            <div>
              ...
              <div class="py-1.5 px-5 lg:float-right">
                <img class="w-[460px] h-[460px] rounded-md shadow-md shadow-gray-800" src={roomCW} alt="A CFD simulation displayed in the CFD Viewer Application">
              </div>
              ...
              <Text classStr="pt-1.5">
                ...
                Please keep in mind that this page is purely for demoing purposes. The application may be slow to load as it is deployed on free infrastructure.
              </Text>
            </div>
        ...
        <section use:scrollRef={'contact'} class="w-full min-h-screen flex flex-col items-center pt-3">
          <div class="w-[70%] flex flex-col gap-5 pt-5">
            ...
            <div class="flex mt-10 gap-3 h-7 items-center">
              <a class="p-3 bg-cyan-950 rounded-full" href="mailto:robin.salminen@hotmail.com" target="_blank">
              ...
              <a class="text-blue-700 hover:text-blue-900 hover:border-b-2 border-cyan-950 text-[17px]" href="mailto:robin.salminen@hotmail.com" target="_blank">robin.salminen@hotmail.com</a>
            </div>

            <div class="flex mt-8 gap-3 h-7 items-center">
              <a class="p-3 bg-cyan-950 rounded-full" href="https://github.com/RSalminen" target="_blank">
              ...
              <a class="text-blue-700 hover:text-blue-900 hover:border-b-2 border-cyan-950 text-[17px]" href="https://github.com/RSalminen" target="_blank">github.com/RSalminen</a>
            </div>

            <div class="flex mt-8 gap-3 h-7 items-center">
              <a href="https://www.linkedin.com/in/robin-salminen-b01410173/" class="p-[14px] bg-cyan-950 rounded-full" target="_blank">
              ...
              <a class="text-blue-700 hover:text-blue-900 hover:border-b-2 border-cyan-950 text-[17px]" href="https://www.linkedin.com/in/robin-salminen-b01410173/" target="_blank">linkedin.com/in/robin-salminen-b01410173/</a>
            </div>
          </div>
        </section>
      </div>
